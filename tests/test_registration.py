...
class TestRegistration:
    ...
    def test_registration_success(self, driver):
        ...
        ).send_keys(email_data)

        driver.find_element(*locators_reg.PASSWORD_INPUT).send_keys(password_data)
        driver.find_element(*locators_reg.PASSWORD_REPEAT_INPUT).send_keys(password_data)
